...
<script>
    ...
    categoria.addEventListener("change", function() {
      ...
      producto.innerHTML = "<option>Productos</option>"
      ...
      fetch('./db/obtenerProductos.php', {
        ...
        .then(data => {
          ...
          if (data > 0) {
            ...
            cantidad.setAttribute("maxLength",stockMaximo.length)
          }
        })
    })

 
    retiroCantidad.addEventListener("focusout", function() {
      let cantidadToInt=parseInt(retiroCantidad.value,10)
      let stockToInt=parseInt(stockMaximo,10)
    ...
    registrarRetiro.addEventListener("click",function(e) {
      ...
      if(status){
        ...
        .then(data => {
          if (alertRetiroWarning.classList.contains("d-block")) {
            alertRetiroWarning.classList.remove("d-block")
            alertRetiroWarning.classList.add("d-none")
          }
          if (data) {
